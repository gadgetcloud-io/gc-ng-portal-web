#!/bin/bash
# ========================================
# GadgetCloud S3+CloudFront Deployment Script
# ========================================
#
# Deploys Angular app to S3 and invalidates CloudFront cache
#
# Usage:
#   ./deploy-to-s3.sh stg     # Deploy to staging
#   ./deploy-to-s3.sh prd     # Deploy to production
#
# Prerequisites:
